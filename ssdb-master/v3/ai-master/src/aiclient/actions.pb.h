...
class ActionVector;
class ActionVectorDefaultTypeInternal;
extern ActionVectorDefaultTypeInternal _ActionVector_default_instance_;
}  // namespace pb
...
class ActionVector : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.ActionVector) */ {
 public:
  ...
  static inline const ActionVector* internal_default_instance() {
    return reinterpret_cast<const ActionVector*>(
  ...
  inline ActionVector* New() const PROTOBUF_FINAL { return New(NULL); }

  ActionVector* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
