...
#ifndef PROTOBUF_request_5fexample_2eproto__INCLUDED
#define PROTOBUF_request_5fexample_2eproto__INCLUDED
...
class request_example_req_t;
class request_example_req_tDefaultTypeInternal;
extern request_example_req_tDefaultTypeInternal _request_example_req_t_default_instance_;
...
class Person_PhoneNumber : public ::google::protobuf::Message   {
 ...
 private:
  ...
  friend struct  protobuf_request_5fexample_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class request_example_req_t : public ::google::protobuf::Message   {
 public:
  request_example_req_t();
  virtual ~request_example_req_t();

  request_example_req_t(const request_example_req_t& from);

  inline request_example_req_t& operator=(const request_example_req_t& from) {
    CopyFrom(from);
    return *this;
  }

  static const ::google::protobuf::Descriptor* descriptor();
  static const request_example_req_t& default_instance();

  static inline const request_example_req_t* internal_default_instance() {
    return reinterpret_cast<const request_example_req_t*>(
               &_request_example_req_t_default_instance_);
  }

  void Swap(request_example_req_t* other);

  // implements Message ----------------------------------------------

  inline request_example_req_t* New() const PROTOBUF_FINAL { return New(NULL); }

  request_example_req_t* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const request_example_req_t& from);
  void MergeFrom(const request_example_req_t& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(request_example_req_t* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // @@protoc_insertion_point(class_scope:request_example_req_t)
 private:
...
// repeated .Person people = 1;
inline int request_example_req_t::people_size() const {
  return people_.size();
}
inline void request_example_req_t::clear_people() {
  people_.Clear();
}
inline const ::Person& request_example_req_t::people(int index) const {
  // @@protoc_insertion_point(field_get:request_example_req_t.people)
  return people_.Get(index);
}
inline ::Person* request_example_req_t::mutable_people(int index) {
  // @@protoc_insertion_point(field_mutable:request_example_req_t.people)
  return people_.Mutable(index);
}
inline ::Person* request_example_req_t::add_people() {
...
#endif  // PROTOBUF_request_5fexample_2eproto__INCLUDED
